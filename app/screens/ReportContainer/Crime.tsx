...
const Crime = ({ navigation }: any) => {
  ...
  async function submitReport() {
    try {
      ...
      formData.append("state_name", String(selectedState || ""));
      formData.append("lga_name", String(selectedLocalGov || ""));
  ...
  const checkedBoxFucn = (value: any) => {
    if (value === checked) {
      setChecked(true);
      setUnChecked(false);
    ...
    <ReportWrapper title="Crime & Safety">
      ...
      <Modal animationType="slide" transparent={true} visible={modalOpen}>
        ...
        >
          ...
          >
            <Image
              source={icons.CancelPNG || undefined}
              resizeMode="contain"
              style={{
                width: 15,
                height: 15,
          ...
          <View>
            ...
            >
              {imageLoading ? (
                ...
                <Image
                  source={icons.folderoutline || undefined}
                  resizeMode="contain"
                  style={{
