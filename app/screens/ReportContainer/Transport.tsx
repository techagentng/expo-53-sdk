...
const Transport = ({ navigation }: any) => {
  ...
  const transport = [
    {
      label: "Public Transportation Reliability",
      value: "Public Transportation Reliability",
    },
    { label: "Congestion", value: "Congestion" },
    { label: "Safety Measures", value: "Safety Measures" },
    {
      label: "Accessibility for People with Disabilities",
      value: "Accessibility for People with Disabilities",
    },
    {
  ...
  return (
    <ReportWrapper title="Transportation">
      ...
      <View style={styles.checkBoxContainer}>
        ...
        >
          What is your overall ration of the Road?
        </Text>
